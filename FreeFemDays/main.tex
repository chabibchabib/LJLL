...
\uncover<2>{
  \begin{tikzpicture}[remember picture, overlay]
      ...
      \node at (current page.north west) [xshift=9cm, yshift=-3.15cm] {
      \begin{tikzpicture}
          \draw[color=blue][->, thick] (0,0) -- (1,0) ;
          \node at (3.9,0) {\textcolor{blue}{Interpolation weights Not needed for Lagrange}};
      \end{tikzpicture}
      };
...
\begin{tabular}{ c c c }
 ...
 Interpolation weights array  & \texttt{0} & \texttt{0}  \\  
