...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Numerotation \texttt{FreeFem++}}
...
\end{block}
  ...
  \begin{minipage}{80mm}
    \vspace{0.5cm}
    \begin{itemize}[label={}]
      \item \textbf{\textcolor{blue}{\huge \checkmark}}
      \item \textbf{\textcolor{blue}{\huge \checkmark}}
      \item \textbf{\textcolor{blue}{\huge \checkmark}}
      \item \textbf{\textcolor{red}{\huge X}}
      \item \textbf{\textcolor{red}{\huge X}}
      \item \textbf{\textcolor{red}{\huge X}}
    \end{itemize}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Lagrange FE in \texttt{FreeFem++}}
  \begin{minipage}{70mm}
...
\uncover<2>{
  \begin{tikzpicture}[remember picture, overlay]
      ...
      \node at (current page.north west) [xshift=10cm, yshift=-2.1cm] {
          \begin{tikzpicture}
      ...
      \node at (current page.north west) [xshift=10cm, yshift=-1.8cm] {
      \begin{tikzpicture}
          \draw[color=blue][->, thick] (0,0) -- (1,0) ;
      ...
      \node at (current page.north west) [xshift=9.6cm, yshift=-2.5cm] {
      \begin{tikzpicture}
          \draw[color=blue][->, thick] (0,0) -- (1,0) ;
          \node at (1.8,0) {\textcolor{blue}{Data table}};
      \end{tikzpicture}
      };

      \node at (current page.north west) [xshift=9.8cm, yshift=-3.45cm] {
      \begin{tikzpicture}
      ...
      \node at (current page.north west) [xshift=7.7cm, yshift=-4.5cm] {
      \begin{tikzpicture}
          \draw[decorate,color=blue, decoration={brace, amplitude=10pt, mirror}]
...
\begin{tabular}{ c c c }
 ...
 cell7 & \texttt{1} & cell9  \\
 Data table & \texttt{Data} & \texttt{Data}  \\  
 Interpolation order  & \texttt{4} & $k$  \\  
 cell7 & \texttt{15+6} & cell9  \\  
 cell7 & \texttt{15} & cell9  \\  
 cell7 & \texttt{0} & to fill  \\  
